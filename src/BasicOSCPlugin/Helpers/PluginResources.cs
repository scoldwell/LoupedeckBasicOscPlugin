namespace Loupedeck.BasicOSCPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.BasicOSCPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.BasicOSCPlugin.Resources.Resource.txt`.
